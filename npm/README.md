...
npm install -g https://github.com/David-art-beep/Deepresearch-cli/releases/download/v0.1.2/david-art-beep-deepresearch-cli-0.1.2.tgz
```
...
```bash
npm install -g ./dist/david-art-beep-deepresearch-cli-0.1.2.tgz
deepresearch --help
```
...
```bash
npm login
npm publish ./dist/david-art-beep-deepresearch-cli-0.1.2.tgz --access public
```
